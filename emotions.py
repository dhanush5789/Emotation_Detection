...
train_dir = 'D:\desktop\Emotion-detection.zip\Emotion-detection\data\train'
val_dir = 'D:\desktop\Emotion-detection.zip\Emotion-detection\data\test'
...
# Display emotions on your face from the webcam feed
elif mode == "display":
